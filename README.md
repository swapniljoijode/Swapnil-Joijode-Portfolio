...
**Live site:** https://swapnil-joijode-portfolio.vercel.app
**Repository:** https://github.com/swapniljoijode/Swapnil-Joijode-Portfolio
...
```bash
git clone https://github.com/swapniljoijode/Swapnil-Joijode-Portfolio.git
cd Swapnil-Joijode-Portfolio
...
[`swapniljoijode/Swapnil-Joijode-Portfolio`](https://github.com/swapniljoijode/Swapnil-Joijode-Portfolio):

1. Push changes to the `main` branch on GitHub.
2. On [vercel.com](https://vercel.com), **Add New → Project → Import** `Swapnil-Joijode-Portfolio`.
